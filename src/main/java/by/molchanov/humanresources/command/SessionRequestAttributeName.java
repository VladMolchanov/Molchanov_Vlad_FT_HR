...
public final class SessionRequestAttributeName {
    ...
    public static final String START_ORGANIZATION_NUMBER = "start_organization_number";
    ...
    public static final String ORGANIZATIONS_QUANTITY = "organizations_quantity";
    ...
    public static final String ORGANIZATIONS_COUNT = "organizations_count";
