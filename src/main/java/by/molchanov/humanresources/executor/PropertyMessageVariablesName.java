...
public class PropertyMessageVariablesName {
    ...
    public static final String USER_REGISTRATION_INCORRECT_NAME_SURNAME = "content.information.user.registration.incorrect.name.surname";
    public static final String USER_REGISTRATION_INCORRECT_PASS = "content.information.user.registration.incorrect.password";
    public static final String USER_REGISTRATION_NOT_AVAILABLE_EMAIL_ADDRESS = "content.information.user.registration.not.available.email";
    public static final String USER_REGISTRATION_NOT_SAME_PASS = "content.information.user.registration.not.same.password";
    public static final String USER_SUCCESSFUL_REGISTRATION = "content.information.successful.registration";
